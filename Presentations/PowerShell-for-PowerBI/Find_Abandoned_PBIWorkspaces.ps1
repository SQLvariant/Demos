...
Restore-PowerBIWorkspace -Id "3244f1c1-9383-457f-01cf-6035e4950fdc" -RestoredName "TestWorkspace" -AdminEmailAddress "john@contoso.com"
...
Add-PowerBIWorkspaceUser -Scope Organization -Id f2a0fae5-97da-4ee6-1c37-c9d31851fe17 -UserPrincipalName 'john@contoso.com' -AccessRight Admin